...
abstract class AbstractTelegramBotService
{
    ...
    public function __construct(HttpClientInterface $httpClient, string $botToken, string $webhookUrl, string $name)
    {
        $this->httpClient = $httpClient;
        $this->botToken = $botToken;
        $this->webhookUrl = $webhookUrl;
        $this->name = $name;
        $this->telegram = new Telegram($this->botToken, $this->name);
    }
    ...
    public function setWebhook(): string
    {
        try {
            ...
            $telegram = new Telegram($this->botToken, $this->name);
